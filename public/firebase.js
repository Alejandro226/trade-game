...
import { getAuth, signInAnonymously, onAuthStateChanged, updateProfile } from "https://www.gstatic.com/firebasejs/10.13.1/firebase-auth.js";
...
export { signInAnonymously,onAuthStateChanged,updateProfile,doc,getDoc,setDoc,updateDoc,onSnapshot,collection,query,where,addDoc,serverTimestamp,runTransaction,getDocs,orderBy,limit,ref,onDisconnect,onValue,rset,rts };
